...
/// Canonical-session-name parity fixture corpus (maw-js), exported so
/// downstream parity tests need no filesystem path into this repo.
pub const CANONICAL_SESSION_NAME_FIXTURES_JSON: &str =
    include_str!("../tests/fixtures/canonical-session-name.fixtures.json");

/// Canonical-node-identity parity fixture corpus (maw-js), exported so
/// downstream parity tests need no filesystem path into this repo.
pub const CANONICAL_NODE_IDENTITY_FIXTURES_JSON: &str =
    include_str!("../tests/fixtures/canonical-node-identity.fixtures.json");
