...
/// Plugin-policy parity fixture corpus (maw-js `plugin-policy.fixtures.json`),
/// exported so downstream parity tests need no filesystem path into this repo.
pub const PLUGIN_POLICY_FIXTURES_JSON: &str =
    include_str!("../tests/fixtures/plugin-policy.fixtures.json");
