...
/// Split-policy parity fixture corpus (maw-js `split-policy.fixtures.json`),
/// exported so downstream parity tests need no filesystem path into this repo.
pub const SPLIT_POLICY_FIXTURES_JSON: &str =
    include_str!("../tests/fixtures/split-policy.fixtures.json");
