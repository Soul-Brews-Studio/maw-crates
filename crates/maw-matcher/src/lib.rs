...
pub const MATCHER_RESOLVE_TARGET_FIXTURES_JSON: &str =
    include_str!("../tests/fixtures/matcher-resolve-target.fixtures.json");

#[cfg(feature = "fixtures")]
pub const NORMALIZE_TARGET_FIXTURES_JSON: &str =
    include_str!("../tests/fixtures/normalize-target.fixtures.json");
